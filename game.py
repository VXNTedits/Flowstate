...
class Game:
    ...
    def run(self):
        ...
        while not self.window.should_close():
            ...
            projection_matrix = glm.perspective(glm.radians(90.0), self.window.width / self.window.height, 0.1, 1000.0)
            ...
            #self.components.text_renderer.render_text("FPS: {}".format(int(1.0 / delta_time)), 10, 10, 1.0)
