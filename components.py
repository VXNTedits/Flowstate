...
class ObjectAttributes:
    def __init__(self, filepath, mtl_filepath, rotation=[0, 0, 0], translation=[0, 0, 0], material_override=None, scale=1):
        self.scale = scale
...
class Components:
    ...
    def initialize_gameplay_components(self):
        ...
        world_objects = [
            ObjectAttributes('obj/cube.obj', 'obj/cube.mtl', (-45.0, 45.0, 45.0), (-70.0, 0.0, 50.0), MaterialOverride(None, glm.vec3(1, 1, 0), 1000.0)),
            ObjectAttributes('obj/cube.obj', 'obj/cube.mtl', (-45.0, 45.0, 45.0), (20.0, 0.0, -50.0), MaterialOverride(None, glm.vec3(0, 1, 0), 1000.0))
        ]
        ...
        deagle = InteractableObject(filepath='obj/deagle_main.obj', mtl_filepath='obj/deagle_main.mtl', translation=glm.vec3(2.0, 0.0, 0.0), rotation=glm.vec3(90, 0, 0), scale=1, is_collidable=False, material_overrides=MaterialOverride(None, glm.vec3(1, 1, 1), 500), use_composite=True)
        deagle_slide = Model(filepath='obj/deagle_slide.obj', mtl_filepath='obj/deagle_slide.mtl', shift_to_centroid=True, scale=1)
        deagle.add_comp_model(model=deagle_slide, scale=2, relative_position=glm.vec3(0.0, 0.0, 0.0), relative_rotation=glm.vec3(0.0, 0.0, 0.0))

        self.interactables = [deagle]
        ...
        self.player = Player('obj/body.obj', 'obj/head.obj', 'obj/arm_right.obj', mtl_path='obj/body.mtl', camera=self.camera, default_material=Model.default_material, filepath='obj/body.obj', mtl_filepath='obj/body.mtl')
