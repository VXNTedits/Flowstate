...
class Components:
    def __init__(self, window):
        ...
        # Define filepaths, rotations, and translations for multiple objects
        filepaths = ['obj/world_test.obj', 'obj/donut.obj', 'obj/roof.obj']
        rotations = [(-90.0, 0.0, 0.0), (45.0, 45.0, 45.0), (-90.0, 0.0, 0.0)]
        translations = [(-70.0, -2.0, 50.0), (-30.0, 0.5, -40.0), (-70.0, -10.0, 50.0)]

        self.world = World(filepaths, rotations, translations)
